            ...
            <div class="col-sm-12">
                <?= form_open('extraservice/edit') ?>
                    ...
                    ?>
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="title" name="title" value="<?=set_value('title', $extraservice->title)?>" placeholder="<?=$this->lang->line("extraservice_title")?>">
                        </div>
